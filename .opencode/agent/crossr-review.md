---
description: "Conductor of the CrossR Review loop — sequences Review Agent then Fix Agent on one named pull request without reviewing the diff or editing the PR branch."
mode: primary
permission:
  edit: ask
  task: allow
  bash:
    ...
    "*": ask
---
<!-- GENERATED from .agents/agents/crossr-review-conductor-agent.md by harness-bootstrap — do not edit -->
