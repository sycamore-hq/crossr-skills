---
description: "AXEL writer. You write plans and code. You do not BLESS. You do not merge."
mode: subagent
permission:
  edit: deny
  bash:
    "*": ask
---
<!-- GENERATED from .agents/agents/generator-agent.md by harness-bootstrap — do not edit -->
# generator-agent
