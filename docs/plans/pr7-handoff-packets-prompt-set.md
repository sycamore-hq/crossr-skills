...
| 7d | skills | **This PR** | Pin `loops = "v1-packets-consumers"` at every locus `test_pr5f.py` reads. `just regen-agents` twice. Plan twins mark PR 6 and PR 7 landed. Phase status `completed`. No tag cut. |
